...
Each skill is also available as a **slash command** in Claude Code: type `/` + skill name (e.g. `/senior-architect`, `/code-reviewer`, `/copywriting`).
Full list of commands in `.claude/commands/`
            ...
            "SessionStart": [
                {
                    ...
                    "hooks": [
                        {
                            "type": "command",
                            "command": "echo '🚀 Devlmer Ecosystem Engine v3.0 — Skills, MCPs, and agents loaded. Type / to see slash commands.'"
                        }
                    ]
                }
            ],
